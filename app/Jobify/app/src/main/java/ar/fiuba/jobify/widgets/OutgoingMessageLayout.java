package ar.fiuba.jobify.widgets;
 ...
 * Layout para mensajes salientes del chat.
 */
public class OutgoingMessageLayout extends RelativeLayout {

    public OutgoingMessageLayout(Context context) {
        super(context);
    }

    public OutgoingMessageLayout(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public OutgoingMessageLayout(Context context, AttributeSet attrs, int defStyle) {
